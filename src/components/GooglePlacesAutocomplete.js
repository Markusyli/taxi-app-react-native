...
const TouchableHighlight = Platform.select({
  ios: () => TouchableHighlightIOS,
  android: () => TouchableHighlightAndroid,
})();
...
export default class GooglePlacesAutocomplete extends Component {
  ...
  _renderRowData = (rowData) => {
    ...
    return (
      <View>
        <Text
          style={[this.props.suppressDefaultStyles ? {} : defaultStyles.description, this.props.styles.description, rowData.isPredefinedPlace ? this.props.styles.predefinedPlacesDescription : {}]}
          numberOfLines={this.props.numberOfLines}
        >
          {this._renderDescription(rowData)}
        </Text>
        <Text>{rowData.structured_formatting.secondary_text}</Text>
      </View>
    );
  }
